...
public class TemplateManagerServiceImpl implements TemplateManagerService {
    ...
    private TemplateLineService linesService;
    private TemplateClientService templateClientService;

    @Autowired
    public TemplateManagerServiceImpl(TemplateHeaderService headerService,
    ...
    private Template getTemplate(Long tenantId, String templateCode) {
        TemplateHeader templateHeader = getTemplateInfo(tenantId, templateCode);
